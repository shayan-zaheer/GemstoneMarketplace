...
const Checkout = () => {
  ...
  return (
    <div className={"w-full  bg-main py-20"}>
      {!isEmpty ? (
        <>
          <div className="w-full h-32 bg-surface flex items-center justify-center border-t-2 border-b-2 border-[#f9f9f915]">
            <h1 className="text-5xl text-primary font-semibold">Checkout</h1>
          </div>
